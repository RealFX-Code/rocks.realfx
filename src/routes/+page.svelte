...
<section class="mx-auto w-[calc(100%-10%)] sm:w-[calc(100%-35%)]">
    ...
    <P>
        Hi, you've seen my name above so I'll skip that part. I'm a {age} year old girl who's into technology stuff.<br>
        I'm autistic, and technology (anything computers) is my hyperfixation, so I spend all of my time on it.
        Mainly I like to play with obscure computers, and make devices to stuff they weren't intended to, like the obligatory neofetch!<br>
        If you're against LGBTQ+ in any way, GTFO. I'm transgender and strongly want to fight for transgender rights.
    </P>
    <br />
    <Card class="w-max max-w-fit bg-primary-50 dark:border-primary-700 dark:bg-primary-800">
        <P>
            Want to know how to address me properly? Check out: <A target="_blank" href="https://prns.realfx.rocks/@sometime">prns.realfx.rocks/@sometime</A>
        </P>
    </Card>
</section>
